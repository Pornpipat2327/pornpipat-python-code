...
class Vehicle:
    ...
    def get_info(self):
        return f"Breand: {self.brand}, Model: {self.model}, Year: {self.year}"
...
class Car(Vehicle):
    ...
    def get_info(self):
        return f"Breand: {self.brand}, Model: {self.model}, Year: {self.year}, Number of Doors: {self.number_of_doors} "
